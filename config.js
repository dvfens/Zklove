...
export const config = {
  ...
  blockchain: {
    ...
    contracts: {
      identityVerification: IDENTITY_VERIFICATION_CONTRACT || '0x1234567890123456789012345678901234567890',
      merkleTree: MERKLE_TREE_CONTRACT || '0x1234567890123456789012345678901234567890',
      zkDating: process.env.ZK_DATING_CONTRACT || '0x2345678901234567890123456789012345678901'
    },
